...
(function($){
  ...
  $.mbSlider={
	...
	/* isolate slider binding in function */
	bindSliderEvents: function(slider){
	...
	/* method to re-enable slider bindings */
	enableSlider: function(){
		return this.each(function(){
			var slider = this;
			$.mbSlider.bindSliderEvents(slider);			
			});
		},
	
	/* method to unbind slider bindings */
  ...
  /* jQury method to access enable and disable */
  $.fn.enableSlider = $.mbSlider.enableSlider;
  $.fn.disableSlider = $.mbSlider.cancelSlider;
